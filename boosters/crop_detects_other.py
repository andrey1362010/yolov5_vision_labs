...
IMAGES_PATH = "/media/andrey/big/preprocess/HANDS/train/images/*"
SAVE_PATH = "/media/andrey/big/preprocess/HANDS_CROPPED_OTHER"
...
def increase_box(box, image_size_x, image_size_y, zoom=2.):
...
for path, img, im0s, vid_cap in tqdm(dataset):
    ...
    if random.random() < 0.3:
        for i in range(3):
            box = random_box(im0s.shape[1], im0s.shape[0])
